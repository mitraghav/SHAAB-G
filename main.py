...
<html lang="en" style="height: 100%">
    <head>
        ...
        <link rel="stylesheet" href="/static/CACHE/css/output.dd8a81d47a2f.css" type="text/css" media="screen">
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "ff9slZ9CpyszrkAaL8q22XZQaZ6x4LvM68xZfmU7VUQ5DA4sC5dUe8wXl85TA1gT";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="ff9slZ9CpyszrkAaL8q22XZQaZ6x4LvM68xZfmU7VUQ5DA4sC5dUe8wXl85TA1gT">
    <table>
...
<div class="clear"></div>
  ...
  <footer id="id_copyright_div" class="footer">
    <p>
      Copyright &copy; 2011-2024 <a href="/about/company_details/">PythonAnywhere LLP</a>
      &mdash;
